...
{%- for event in site.data.bhf-events-2025 -%} 
  <hr/>
  <img src="images/{{event.ImageName}}" alt="{{event.ImageDesc}} | Credit {{event.ImageCredit}}" style="float: left; height: 80px; margin-top: 20px; margin-left: 20px; margin-right: 20px;">
